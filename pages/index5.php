...
<img src="overtime_logo.png" id="logo">
  ...
  <div id="main">
    ...
    <div class="block" id="block12"><input type="text" id="input12" onchange="funkcja('input12', this.value)"><p>B3</p></div>
    <div class="block" id="block13"><input type="text" id="input13" onchange="funkcja('input13', this.value)"><p>C3</p></div>
    <div class="block" id="block14"><p>D3</p><h1>SNITCH</h1><h3>Komórki A1-C1 zawierają nazwy zabijających ról należących do klasy Crewmate. SPY jest w D4, a JESTER gdzieś w kolumnie E.</h3></div>
